...
const applyFillStyle = (
  ...
  switch (fillStyle) {
    case "hachure-reverse":
      options.fillStyle = "hachure";
      options.hachureAngle = 41;
      break;
    case "hachure-vertical":
      options.fillStyle = "hachure";
      options.hachureAngle = 180;
      break;
    case "hachure-horizontal":
      options.fillStyle = "hachure";
      options.hachureAngle = 90;
      break;
    default:
...
export const generateRoughOptions = (
  ...
  switch (element.type) {
    ...
    case "diamond":
    case "ellipse": {
      applyFillStyle(options, element.fillStyle);
