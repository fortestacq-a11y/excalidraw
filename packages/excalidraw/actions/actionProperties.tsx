...
import {
  ...
  TextAlignMiddleIcon,
  FillHachureIcon,
  FillHachureReverseIcon,
  FillHachureVerticalIcon,
  FillHachureHorizontalIcon,
  FillCrossHatchIcon,
  FillSolidIcon,
        ...
        <div className="buttonList">
          <RadioSelection
            ...
            options={[
              ...
              {
                value: "hachure-reverse",
                text: t("labels.hachureReverse"),
                icon: FillHachureReverseIcon,
                testId: `fill-hachure-reverse`,
              },
              {
                value: "hachure-vertical",
                text: t("labels.hachureVertical"),
                icon: FillHachureVerticalIcon,
                testId: `fill-hachure-vertical`,
              },
              {
                value: "hachure-horizontal",
                text: t("labels.hachureHorizontal"),
                icon: FillHachureHorizontalIcon,
                testId: `fill-hachure-horizontal`,
              },
              {
                value: "cross-hatch",
